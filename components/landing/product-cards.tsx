    ...
    <section className="scroll-reveal relative bg-[#050505] px-6 py-24 md:px-12 overflow-hidden lg:py-32 border-t border-white/5">
      ...
      <div className="relative z-10 mx-auto max-w-[1400px]">
          ...
          {CARDS.map((card) => (
            <div
              ...
              className={`group relative flex flex-col rounded-[16px] border p-8 md:p-10 transition-all duration-500 hover:-translate-y-1.5 ${
                card.featured
                  ? "border-accent/20 bg-surface shadow-[0_12px_40px_rgba(200,240,0,0.05)]"
                  : "border-white/5 bg-surface hover:border-accent/30 hover:shadow-[0_12px_40px_rgba(200,240,0,0.08)]"
              }`}
            >
              {/* Numéro */}
        ...
        <div className="mt-14 text-center">
          <Link
            href="/solutions/creation-site-web"
            className="group inline-flex items-center gap-2 rounded-full border border-accent/20 bg-accent/[0.04] px-8 py-3.5 text-base font-semibold text-accent transition-all hover:bg-accent hover:text-accent-foreground hover:shadow-[0_0_40px_rgba(200,240,0,0.3)]"
          >
            Voir nos solutions
...
function BrowserMockup() {
  return (
    <svg viewBox="0 0 280 180" className="w-full h-full">
      ...
      <rect x="40" y="105" width="200" height="50" rx="5" fill="#c8f000" opacity="0.06" stroke="currentColor" strokeWidth="1" strokeOpacity="0.15" />
